...
//                            console.log("removed from favs");
            ...
            window.ATL_JQ_PAGE_PROPS =  {
                ...
                fieldValues: {
                    'summary' : 'Förslag på synonymer för begreppet: ' + componentsRegistry[1].getConceptId(),
                    'customfield_10602' : componentsRegistry[1].getConceptId(),
                    'customfield_10601' : componentsRegistry[1].defaultTerm
                }
            };
            //end
